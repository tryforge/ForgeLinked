...
exports.default = new ForgeLinkedEventManager_1.ForgeLinkedEventHandler({
    name: 'linkedChapterStarted',
    version: '2.0.0',
    description: 'Triggered when a specific chapter starts playing',
    listener(player, track, payload) {
        const commands = this.getExtension(__1.ForgeLinked, true).commands.get('linkedChapterStarted');
...
//# sourceMappingURL=linkedChapterStarted.js.map