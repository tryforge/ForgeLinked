...
exports.default = new forgescript_1.NativeFunction({
    ...
    execute(ctx, [guildId]) {
        try {
            ...
            return this.success(player.volume ?? 0);
        }
        catch (err) {
            return this.customError(`Failed to get volume: ${err instanceof Error ? err.message : String(err)}`);
        }
    },
});
//# sourceMappingURL=playerGetVolume.js.map