...
exports.default = new forgescript_1.NativeFunction({
    ...
    args: [
        {
            name: 'guildId',
            description: 'The guild id to restart the current track for',
    ...
    async execute(ctx, [guildId]) {
        try {
            ...
            return this.customError(`Failed to replay track: ${err instanceof Error ? err.message : String(err)}`);
        }
    },
});
//# sourceMappingURL=playerReplay.js.map